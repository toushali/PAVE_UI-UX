...
(function () {
  ...
  /* ---- Light / dark theme toggle (Pro2 only). Persists to localStorage;
     the <head> bootstrap applies it before paint to avoid a flash. ---- */
  function initThemeToggle() {
    ...
    document.addEventListener("click", function (e) {
      ...
      try { localStorage.setItem("kivie-pro2-theme", next); } catch (err) {}
    });
  }
  ...
  function initDesignToggle() {
    ...
    var accent = (cs.getPropertyValue("--c-primary") || "").trim() || "#21B6C4";
    var accentSoft = (cs.getPropertyValue("--c-primary-soft") || "").trim() || "rgba(33,182,196,0.15)";
