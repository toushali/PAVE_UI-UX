...
(function () {
  ...
  /* ============================================================
     S4 — one mock feed drives BOTH the bell and the Reminders nav
     badge, so a count can never disagree with itself (D3.5, D6.3).
     Bell shows UNREAD; the Reminders badge shows OPEN items.
     ============================================================ */
  var NOTIFS = [
  ...
  var NAV = [
    ...
    ["reminders","Reminders",'<path d="M6 9a6 6 0 0 1 12 0c0 5 2 6 2 6H4s2-1 2-6"/><path d="M10 20a2 2 0 0 0 4 0"/>',String(OPEN),"Clinical"],
    ...
    ["dr-brain","Dr. Brain",'<path d="M12 4a3.5 3.5 0 0 0-3.5 3.5A3 3 0 0 0 6 13a3 3 0 0 0 3 3 3 3 0 0 0 6 0 3 3 0 0 0 3-3 3 3 0 0 0-2.5-5.5A3.5 3.5 0 0 0 12 4z"/><path d="M12 8v4"/><path d="M9.5 10.5 12 12l2.5-1.5"/>',"","Practice"],
  ...
  /* S4/D6.3 — bell = peek · Reminders = full history + triage ·
     Settings = delivery channels. Three views, one feed. */
  var NOTIF_FOOT =
    '<a href="reminders.html">View all</a><span class="spacer"></span>' +
  ...
  function acctMenu() {
    ...
    return '<span class="dd dd--end" data-menu>' +
      '<button class="avatar avatar--btn" data-menu-trigger type="button" aria-haspopup="menu" aria-expanded="false" aria-label="Account menu — Dr. Brandon Stillman">BS</button>' +
      '<div class="dd__menu acctmenu" role="menu">' +
        '<div class="acctmenu__id"><span class="avatar avatar--sm">BS</span><span>' +
          '<strong>Dr. Brandon Stillman, MD</strong>' +
          '<span class="t-meta">b.stillman@stillmanrehab.com</span>' +
          '<span class="t-meta">Stillman Rehabilitation Group · Org admin</span>' +
        '</span></div>' +
        '<div class="acctmenu__list">' +
          '<a class="dd__item" role="menuitem" href="settings.html">' + ic('<circle cx="12" cy="8" r="3.4"/><path d="M5 20c0-3.6 3.1-6 7-6s7 2.4 7 6"/>') + 'My profile</a>' +
          ...
          '<a class="dd__item" role="menuitem" href="reminders.html">' + ic('<path d="M6 9a6 6 0 0 1 12 0c0 5 2 6 2 6H4s2-1 2-6"/><path d="M10 20a2 2 0 0 0 4 0"/>') + 'Notification preferences</a>' +
